...
type GreeterClient interface {
	...
	PutStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamReqData, StreamResData], error)
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamReqData, StreamResData], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PutStreamClient = grpc.BidiStreamingClient[StreamReqData, StreamResData]
...
type GreeterServer interface {
	...
	PutStream(grpc.BidiStreamingServer[StreamReqData, StreamResData]) error
...
func (UnimplementedGreeterServer) PutStream(grpc.BidiStreamingServer[StreamReqData, StreamResData]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PutStreamServer = grpc.BidiStreamingServer[StreamReqData, StreamResData]
